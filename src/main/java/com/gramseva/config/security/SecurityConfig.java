...
public class SecurityConfig {
        ...
        http
               ...
               // CORS configuration
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/public/**").permitAll() // Allow access to public endpoints
                        .anyRequest().authenticated() // Secure all other endpoints
                )
                .exceptionHandling(exception -> exception
                        .authenticationEntryPoint(authenticationEntryPoint)
                        .accessDeniedHandler(accessDeniedHandler) // Custom entry point for handling auth errors
                )
    ...
    private void registerPublicOrigins(UrlBasedCorsConfigurationSource source) {
        ...
        publicCorsConfig.setAllowedOriginPatterns(Arrays.asList("*")); // Update with your specific frontend origin
